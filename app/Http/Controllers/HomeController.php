...
class HomeController extends Controller
{
    ...
    public function salvarEmpresa() {
        $this->validate(request(), [
            ...
            'txtNomeEmpresa1' => 'required',
            'txtDataAdmissao1' => 'required|max:10',
            'txtDataSaida1' => 'required|max:10',
            'txtCargo1' => 'required',
            'txtAtividadesRealizadas1' => 'required',
            'txtNomeEmpresa2' => 'nullable',
            'txtDataEmissao2' => 'max:10',
            'txtDataSaida2' => 'max:10',
            'txtCargo2' => 'nullable',
